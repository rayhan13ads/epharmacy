                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <select name="payment_method" class="form-control select2" id="advFieldsStatus">
                                    ...
                                    <option value="SSLCommerz"><?php echo LANG_VALUE_164; ?></option>
                                    <option value="PayPal"><?php echo LANG_VALUE_36; ?></option>
                                </select>
                            </div>

                            <!-- SSLCommerz--->
                            <form class="paypal" action="<?php echo BASE_URL; ?>payment/sslcommerz/ssl_commarz.php"
                                method="post" id="sslcommerz_form" target="_blank">
                                <input type="hidden" name="cmd" value="_xclick" />
                                <input type="hidden" name="no_note" value="1" />
                                <input type="hidden" name="lc" value="BD" />
