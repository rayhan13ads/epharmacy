...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="product-add.php" class="btn btn-primary btn-sm">Add Medicines</a>
	</div>
</section>
				...
				<div class="box-body table-responsive">
					...
					<thead class="thead-dark">
							<tr>
								<th width="10">#</th>
								<th>Photo</th>
								<th width="160">Medicines Name</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Be careful! This product will be deleted from the order table, payment table, unit table, power table and rating table also.</p>
            </div>
