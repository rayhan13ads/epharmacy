    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Be careful! All Medicines under this end category will be deleted from all the tables like order table, payment table, unit table, power table, rating table etc.</p>
            </div>
